...
def calendar_ak(year_start, year_end=None):
    '''Holidays and Non Shopping Sundays in Poland'''
    dict1 = apply_multi(non_shopping_sunday, year_start, year_end)
    dict2 = apply_multi(holiday_regular_dict, year_start, year_end)
    dict3 = apply_multi(easter_dict, year_start, year_end)
    dict4 = apply_multi(holiday_exception, year_start, year_end)
